        ...
        <div className="bg-white grid md:grid-cols-2 lg:gap-24 gap-16 w-full sm:p-8 p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded overflow-hidden">
          <div className="max-md:order-1 space-y-6">
            ...
            <div className="space-y-6">
              ...
              >
                <FaFacebook className="inline mr-4 w-6 h-6" />
              ...
              >
                <FcGoogle className="inline mr-4 w-6 h-6" />
              ...
              >
                <FaApple className="inline mr-4 w-6 h-6" />
                Continue with Apple
              </button>
            </div>
          </div>
          <form className="w-full" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <div>
                <label className="text-sm mb-2 block text-left" htmlFor="email">
                  Email
                </label>
                ...
                {errors.email && touched.email && <small className="text-red-500 text-xs block text-left mt-1">{errors.email}</small>}
              </div>
              <div>
                <label className="text-sm mb-2 block text-left" htmlFor="password">
                  Password
                </label>
                <div className="relative flex items-center">
                  <input
                ...
                {errors.password && touched.password && <small className="text-red-500 text-xs block text-left mt-1">{errors.password}</small>}
              </div>
            ...
            <div className="mt-10">
              <button
                ...
                className="w-full py-3 px-4 text-sm font-semibold cursor-pointer rounded bg-blue-600 hover:bg-blue-700 text-white focus:outline-none hover:rounded-full"
              >
                Login
              </button>
            </div>
